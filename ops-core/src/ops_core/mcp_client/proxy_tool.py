...
class MCPProxyTool(Tool):
    ...
    spec = ToolSpec(
        ...
        input_schema=MCPProxyInput.model_json_schema(), # Pass the JSON schema dict
        output_schema=DEFAULT_SCHEMA.model_dump(mode='json'), # Pass the dumped default schema dict
    )
